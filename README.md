...
- **대규모 연산 최적화**: 기존 CPU만으로 수일이 소요되던 10년 치 데이터(105만 개 5분봉 캔들) 전수조사를 CuPy(CUDA)처리(외장그래픽카드 활용) 추가하여 최적화 모델생성 시간 단축.
...
[![ShopMall 메인화면](https://github.com/gatsby6060/jghshopmall/blob/main/shopmall1.png?raw=true)](https://github.com/gatsby6060/jghshopmall)

- **Java 21 + Spring Boot 3.5 + Next.js 15, Vue.js** 기반 기존대비 기능 향상된 풀스택 쇼핑몰 애플리케이션
